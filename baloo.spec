...
Version  : 5.54.0
Release  : 10
URL      : https://download.kde.org/stable/frameworks/5.54/baloo-5.54.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.54/baloo-5.54.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.54/baloo-5.54.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1547330633
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKF5Baloo.so.5.54.0
/usr/lib64/libKF5BalooEngine.so.5
/usr/lib64/libKF5BalooEngine.so.5.54.0
