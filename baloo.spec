...
Source0  : https://download.kde.org/stable/frameworks/5.68/baloo-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/baloo-5.68.0.tar.xz.sig
...
%prep
%setup -q -n baloo-5.68.0
cd %{_builddir}/baloo-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584322988
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/baloo-5.68.0/COPYING %{buildroot}/usr/share/package-licenses/baloo/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/baloo-5.68.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/baloo/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
