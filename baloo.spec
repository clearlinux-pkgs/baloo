...
Version  : 5.107.0
Release  : 63
URL      : https://download.kde.org/stable/frameworks/5.107/baloo-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/baloo-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/baloo-5.107.0.tar.xz.sig
...
%prep
%setup -q -n baloo-5.107.0
cd %{_builddir}/baloo-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686588171
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5Baloo.so.5.107.0
/V3/usr/lib64/libKF5BalooEngine.so.5.107.0
...
/usr/lib64/libKF5Baloo.so.5.107.0
/usr/lib64/libKF5BalooEngine.so.5
/usr/lib64/libKF5BalooEngine.so.5.107.0
